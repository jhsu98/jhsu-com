<template>
  <div
    ...
    :class="theme"
  >
    <header class="border-t-14 border-yellow-900">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <g-link to="/services/" class="text-copy-primary hover:text-gray-600">Services</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
    ...
    <div class="newsletter bg-background-tertiary" style="height: 290px">
      <!-- <form
        action="https://j-hsu.us19.list-manage.com/subscribe/post?u=8573ee1fa6cac824bbf7e574a&amp;id=142dfa87d9"
        method="post"
          ...
          <div class="w-4/5 mx-auto mb-8">
            ...
            <div class="flex flex-col sm:flex-row">
              <input
                ...
                id="mce-EMAIL"
                class="flex-1 bg-background-form rounded sm:rounded-r-none px-4 py-4 leading-normal border border-border-color-primary sm:border-r-0 shadow outline-none focus:border-yellow-800 z-10"
                required
              />
              <button
                data-element="submit"
                class="flex-2 w-40 uppercase bg-yellow-800 text-white rounded sm:rounded-l-none text-lg py-3 px-8 tracking-wide shadow focus:outline-none hover:bg-yellow-900 focus:bg-yellow-900 z-10 w-full sm:w-auto mt-4 sm:mt-0"
              >
                <span>Subscribe</span>
              </button>
            </div>
      ...
      <iframe
        src="https://code85.substack.com/embed"
        width="100%"
        height="290"
      ...
      <div class="container-inner mx-auto -mt-32 pb-4 overflow-x-hidden">
        <svg width="725" height="100" xmlns="http://www.w3.org/2000/svg">
    ...
    <footer class="bg-yellow-800 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:jonathan@j-hsu.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a
              href="https://www.linkedin.com/in/jhsu98/"
              target="_blank"
